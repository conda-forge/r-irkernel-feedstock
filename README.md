...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5752&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-irkernel-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-irkernel` can be installed with `conda`:
...
It is possible to list all of the versions of `r-irkernel` available on your platform with `conda`:
...
```
mamba search r-irkernel --channel conda-forge
```
...
mamba repoquery search r-irkernel --channel conda-forge

# List packages depending on `r-irkernel`:
mamba repoquery whoneeds r-irkernel --channel conda-forge

# List dependencies of `r-irkernel`:
mamba repoquery depends r-irkernel --channel conda-forge
```
